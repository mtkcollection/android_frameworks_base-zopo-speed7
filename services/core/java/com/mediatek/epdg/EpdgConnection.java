...
class EpdgConnection extends StateMachine implements EpdgCallback {
    ...
    private static final String ALL_MATCH_APN = "*";
    ...
    private void getApnName(String apnTypeName) {
        ...
        if ((mEpdgConfig.apnName == null || mEpdgConfig.apnName.length() == 0)
        ...
        } else if (mEpdgConfig.apnName == null || mEpdgConfig.apnName.length() == 0) {
    ...
    private boolean prepareConfig() {
        ...
        if (operator == null || operator.length() == 0) {
            if (TelephonyManager.SIM_STATE_ABSENT == mTelephonyManager.getSimState()) {
        ...
        mEpdgConfig.imsi = mTelephonyManager.getSubscriberId();
    ...
    private String getAutoEpdgServer() {
        ...
        if (plmn == null || plmn.length() == 0) {
            plmn = mTelephonyManager.getSimOperator();
        }
