...
/* Vanzo:yujianpeng on: Thu, 11 Jun 2015 18:31:19 +0800
 * implement data set
 */
    ...
    protected void handleClick() {
        if (mDataController.isMobileDataSupported() && mState.enabled) {
            ...
            if (!mState.connected) {
                ...
                if (subId < 0) {
/* Vanzo:yujianpeng on: Thu, 11 Jun 2015 18:26:47 +0800
 * implement data set
 */
                    Log.d("yjp","subId<0");
                    ...
                    intent.setComponent(new ComponentName(
                                ...
                                "com.android.settings.sim.SimDataDialogActivity"));
                    Log.d("yjp","startActivity data dialog");
...
/* Vanzo:yujianpeng on: Thu, 11 Jun 2015 21:57:00 +0800
 * implement data set
        }
 */
        } else if(mDataController.isMobileDataSupported()) {
            if (!mState.connected) {
                int subId = SubscriptionManager.getDefaultDataSubId();
                Log.d("yjp","subId: " +subId);
                if (subId < 0) {
                    Intent intent = new Intent();
                    intent.setComponent(new ComponentName(
                                "com.android.settings",
...
/* Vanzo:yujianpeng on: Thu, 11 Jun 2015 18:27:25 +0800
 * implement data set
 */
    protected void handleLongClick() {
        ...
        intent.setComponent(new ComponentName(
            ...
            Log.d("yjp","startActivity Data set");
            mHost.startSettingsActivity(intent);
    }
// End of Vanzo:yujianpeng
